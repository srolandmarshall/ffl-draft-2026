...
class LeagueHistoriesControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    espn_team_seasons(:one).update!(
      ...
      team_abbreviation: "RED", owner_ids: [ "owner-red" ], regular_season_rank: 1
    )
    @older_season.team_seasons.create!(
      espn_franchise: franchise, espn_team_id: 7, team_name: "Red Hawks",
      team_abbreviation: "RED", owner_ids: [ "owner-red" ], owner_names: [], regular_season_rank: 2
    )
  end
  ...
  test "orders franchises by championships then years in the league" do
    ...
    espn_team_seasons(:one).update!(regular_season_rank: 2)
    @season.team_seasons.create!(
      espn_franchise: challenger, espn_team_id: 9, team_name: "Challenger",
      team_abbreviation: "CHL", owner_ids: [ "owner-chl" ], owner_names: [], regular_season_rank: 1
    )
    @older_season.team_seasons.find_by!(espn_team_id: 7).update!(regular_season_rank: 2)
    @older_season.team_seasons.create!(
      espn_franchise: challenger, espn_team_id: 9, team_name: "Challenger",
      team_abbreviation: "CHL", owner_ids: [ "owner-chl" ], owner_names: [], regular_season_rank: 1
    )
