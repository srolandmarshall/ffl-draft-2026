...
class Components::Drafts::PlayerFiltersTest < ActiveSupport::TestCase
  test "renders search, position, and team filter targets" do
    ...
    assert_includes html, "name=\"positions[]\" value=\"QB\" checked class=\"peer sr-only\" data-draft-filter-target=\"position\" data-action=\"change->draft-filter#scheduleSelection\""
    ...
    assert_match(/<details id="draft-sunday-draft-players-team-filter" class="[^"]*w-full[^"]*sm:w-auto" data-turbo-permanent data-draft-filter-target="teamMenu"/, html)
