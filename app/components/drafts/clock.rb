  ...
  def clock_identity
    div(class: "min-w-0") do
      if @draft.live?
        ...
        p(class: "mt-0.5 break-words text-xl font-black text-lime-400 sm:text-2xl") { @draft.current_team&.name }
        p(class: "mt-0.5 text-[.65rem] font-semibold uppercase tracking-[.2em] text-slate-400") { "Round #{@draft.current_round}, Pick #{@draft.next_overall_number}" }
